...
def _panel(
    ...
    - `kind` picks a base theme (error, warning, preview_anchor, preview_cp, …)
    - `border_style` / `title_style` / `label_style` can override the theme.
    ...
    try:
        ...
        # Fallback when Rich or TTY unavailable
