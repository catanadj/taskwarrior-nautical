...
KIT_SCHEMA = 1
ROOT_FILES = ("nautical", "nautical_navigator.py", "on-add.nautical", "on-modify.nautical", "on-exit.nautical", "uda.conf", "requirements.txt", "requirements-astronomy.txt", "config-nautical.toml")
